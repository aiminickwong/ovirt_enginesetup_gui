...
from TUI_startup.app import loader
from TUI_startup.model import defaults
from TUI_startup.app.ui import urwid_builder
from TUI_startup.util import system,Timer,console
...
class Application(base.Base):
    ...
    def __init__(self, plugin_base, args, quit=None,
        ...
        self.ui = self.ui_builder.build(ui.Window("screen", self)) #Instanianate a window
