...
class Plugin(plugins.NodePlugin):
    ...
    def _get_nics(self):
        ...
        node_nics = []
        first_nic = None
        for name, nic in sorted(network.node_nics().items()):
    ...
    def on_merge(self, effective_changes):
        ...
        if "button.ping" in changes:
            ...
            from TUI_startup.engine_setup import ping
            plugin_type = ping.Plugin
...
class NicDetailsDialog(ui.Dialog):
    ...
    def __init__(self, plugin, iface):
        ...
        node_bridge_slave = cnetwork.node_bridge_slave()
        ...
        bridge_nic = network.NIC(live["bridge"])
