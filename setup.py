...
packages = ['urwid','TUI_plugin','TUI_startup/ovirtnode','TUI_startup/config','TUI_plugin/TUI','dialog_plugin','dialog_plugin/dialog','TUI_startup','TUI_startup/core','TUI_startup/core/engine_setup','TUI_startup/model','TUI_startup/util','TUI_startup/app','TUI_startup/app/ui'],
